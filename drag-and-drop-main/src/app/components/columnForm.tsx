...
export function ColumnForm({ handleAddColumn }: ColumnFormProps) {
  const [title, setTitle] = useState("");

  return (
    <div>
      <label className="h-fit w-fit" htmlFor="add-column">
        <div className="flex my-10 mx-1 px-5 py-2.5 h-fit w-96 bg-gray-800 rounded-xl hover:bg-gray-700 cursor-pointer">
          <input type="checkbox" id="add-column" className="hidden peer" />
